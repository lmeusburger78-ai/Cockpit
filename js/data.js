...
(function (C) {
  ...
  C.UNIVERSE = {
    ...
    /* ---- USA (weitere) ---- */
    AMD:   { name: "AMD",                    sector: "Technologie",     base: 165 },
    AVGO:  { name: "Broadcom",               sector: "Technologie",     base: 175 },
    ORCL:  { name: "Oracle",                 sector: "Technologie",     base: 165 },
    ADBE:  { name: "Adobe",                  sector: "Technologie",     base: 520 },
    CRM:   { name: "Salesforce",             sector: "Technologie",     base: 265 },
    INTC:  { name: "Intel",                  sector: "Technologie",     base: 32  },
    NFLX:  { name: "Netflix",                sector: "Kommunikation",   base: 700 },
    MA:    { name: "Mastercard",             sector: "Finanzen",        base: 490 },
    BAC:   { name: "Bank of America",        sector: "Finanzen",        base: 42  },
    BRKB:  { name: "Berkshire Hathaway B",   sector: "Finanzen",        base: 465 },
    PEP:   { name: "PepsiCo",                sector: "Konsum defensiv", base: 155 },
    WMT:   { name: "Walmart",                sector: "Konsum defensiv", base: 82  },
    COST:  { name: "Costco",                 sector: "Konsum defensiv", base: 900 },
    HD:    { name: "Home Depot",             sector: "Konsum zyklisch", base: 400 },
    MCD:   { name: "McDonald's",             sector: "Konsum zyklisch", base: 295 },
    PFE:   { name: "Pfizer",                 sector: "Gesundheit",      base: 27  },
    MRK:   { name: "Merck & Co.",            sector: "Gesundheit",      base: 105 },
    ABBV:  { name: "AbbVie",                 sector: "Gesundheit",      base: 190 },
    CVX:   { name: "Chevron",                sector: "Energie",         base: 155 },

    /* ---- Deutschland / Europa ---- */
    "MBG.DE":  { name: "Mercedes-Benz Group", sector: "Konsum zyklisch", base: 55  },
    "BMW.DE":  { name: "BMW",                  sector: "Konsum zyklisch", base: 80  },
    "VOW3.DE": { name: "Volkswagen Vz.",       sector: "Konsum zyklisch", base: 95  },
    "BAS.DE":  { name: "BASF",                 sector: "Grundstoffe",     base: 45  },
    "BAYN.DE": { name: "Bayer",                sector: "Gesundheit",      base: 28  },
    "DTE.DE":  { name: "Deutsche Telekom",     sector: "Kommunikation",   base: 28  },
    "DBK.DE":  { name: "Deutsche Bank",        sector: "Finanzen",        base: 16  },
    "ADS.DE":  { name: "adidas",               sector: "Konsum zyklisch", base: 225 },
    "RHM.DE":  { name: "Rheinmetall",          sector: "Industrie",       base: 520 },
    "MUV2.DE": { name: "Münchener Rück",       sector: "Finanzen",        base: 480 },
    "AIR.PA":  { name: "Airbus",               sector: "Industrie",       base: 155 },
    "MC.PA":   { name: "LVMH",                 sector: "Konsum zyklisch", base: 640 },
    "TTE.PA":  { name: "TotalEnergies",        sector: "Energie",         base: 60  },
    "NESN.SW": { name: "Nestlé",               sector: "Konsum defensiv", base: 90  },
    "NOVN.SW": { name: "Novartis",             sector: "Gesundheit",      base: 95  },

    /* ---- Österreich (ATX) ---- */
    "VOE.VI":  { name: "voestalpine",              sector: "Grundstoffe",     base: 28  },
    "OMV.VI":  { name: "OMV",                      sector: "Energie",         base: 45  },
    "EBS.VI":  { name: "Erste Group Bank",         sector: "Finanzen",        base: 58  },
    "RBI.VI":  { name: "Raiffeisen Bank Int.",     sector: "Finanzen",        base: 24  },
    "BG.VI":   { name: "BAWAG Group",              sector: "Finanzen",        base: 88  },
    "VIG.VI":  { name: "Vienna Insurance Group",   sector: "Finanzen",        base: 33  },
    "UQA.VI":  { name: "UNIQA Insurance",          sector: "Finanzen",        base: 9   },
    "VER.VI":  { name: "Verbund",                  sector: "Versorger",       base: 70  },
    "EVN.VI":  { name: "EVN",                      sector: "Versorger",       base: 24  },
    "ANDR.VI": { name: "Andritz",                  sector: "Industrie",       base: 58  },
    "WIE.VI":  { name: "Wienerberger",             sector: "Grundstoffe",     base: 32  },
    "MMK.VI":  { name: "Mayr-Melnhof Karton",      sector: "Grundstoffe",     base: 115 },
    "LNZ.VI":  { name: "Lenzing",                  sector: "Grundstoffe",     base: 30  },
    "POST.VI": { name: "Österreichische Post",     sector: "Industrie",       base: 32  },
    "TKA.VI":  { name: "Telekom Austria",          sector: "Kommunikation",   base: 9   },
    "DOC.VI":  { name: "DO & CO",                  sector: "Konsum zyklisch", base: 150 },
    "SBO.VI":  { name: "Schoeller-Bleckmann",      sector: "Energie",         base: 38  },
    "STR.VI":  { name: "STRABAG",                  sector: "Industrie",       base: 44  },
    "ATS.VI":  { name: "AT&S",                     sector: "Technologie",     base: 18  },
    "CAI.VI":  { name: "CA Immobilien",            sector: "Immobilien",      base: 24  },
  };
